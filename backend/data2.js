...
const insertData = async () => {
  try {
    ...
    const users = await User.insertMany([
      { username: 'user1', email: 'user21@example.com', password: 'password123' },
      { username: 'user2', email: 'user22@example.com', password: 'password123' },
      { username: 'user3', email: 'user23@example.com', password: 'password123' },
      { username: 'user4', email: 'user24@example.com', password: 'password123' },
      { username: 'user5', email: 'user25@example.com', password: 'password123' },
    ]);
    ...
    const comments = await Comment.insertMany([
      ...
      { userId: users[4]._id, outfitId: outfits[0]._id, text: "I will def buy the red lipstick!" }
    ]);
